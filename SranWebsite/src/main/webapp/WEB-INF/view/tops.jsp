    ...
    <section class="products-section">
      ...
      <div class="page-title">
        <div class="title-group">
            <h2>Tops</h2>
            <p><a href="${pageContext.request.contextPath}/">Home </a>> Tops</p>
        </div>
        <div class="sort">
...
<div class="product-grid">
  ...
  <c:if test="${currentPage > 1}">
    <a href="${pageContext.request.contextPath}/topsController/tops?page=${currentPage - 1}">&laquo;</a>
  </c:if>

  <c:forEach var="i" begin="1" end="${totalPages}">
    <c:choose>
      <c:when test="${i == currentPage}">
        <a class="active" href="${pageContext.request.contextPath}/topsController/tops?page=${i}">${i}</a>
      </c:when>
      <c:otherwise>
        <a href="${pageContext.request.contextPath}/topsController/tops?page=${i}">${i}</a>
      </c:otherwise>
    </c:choose>
  </c:forEach>

  <c:if test="${currentPage < totalPages}">
    <a href="${pageContext.request.contextPath}/topsController/tops?page=${currentPage + 1}">&raquo;</a>
  </c:if>
</div>
