...
<body>
  ...
  <div class="filter-group">
    <p>Availability</p>
    <form method="get" action="${pageContext.request.contextPath}/dressController/dress">
  <div class="filter-group">
    <label>
      <input type="checkbox" name="inStock" value="true" ${param.inStock == 'true' ? 'checked' : ''} />
      In stock (<c:out value="${size}" />)
    </label>
  </div>
